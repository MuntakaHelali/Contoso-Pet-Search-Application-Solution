...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string[] searchCharacteristics = dogCharacteristic.Trim().Split(",");
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach(var word in searchCharacteristics)
                    {
                        if (word != null && word.Trim() != "")
                        {
                            ...
                            // #5 update "searching" message to show countdown 
                                foreach (string icon in searchingIcons)
                                {
                                    ...
                                    Console.Write($"\rsearching our dog {ourAnimals[i, 3]} for {word} {icon} {j.ToString()}");
                                    Thread.Sleep(100);
                                }
                            ...
                            {   
                                ...
                                Console.WriteLine($"\nOur dog {ourAnimals[i, 3]} is a match for your search for {word.Trim()}");
